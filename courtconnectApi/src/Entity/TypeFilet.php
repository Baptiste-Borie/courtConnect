...
#[ORM\Entity(repositoryClass: TypeFiletRepository::class)]
class TypeFilet
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
     ...
     */
    #[ORM\OneToMany(targetEntity: Terrain::class, mappedBy: 'type_filet')]
    ...
    public function removeTerrain(Terrain $terrain): static
    {
        if ($this->terrains->removeElement($terrain)) {
            ...
            if ($terrain->getTypeFilet() === $this) {
                $terrain->setTypeFilet(null);
            }
        }
